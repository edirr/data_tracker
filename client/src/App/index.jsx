...
class App extends Component {
  ...
  async getSingleStudentScores() {
    const studentTests = `/api/students/${this.state.student_id}/tests`;
  ...
  async getSingleStudentMathScores() {
    const studentMathTests = `/api/students/${this.state.student_id}/mathtests`;
  ...
  async getSingleStudent() {
    const studentId = `/api/students/${this.state.student_id}`;
